...
import static club.yuit.common.response.HttpStatusAndMsg.exs;
...
public final class HttpResponseUtils {
    ...
    public static <T> PageAndSortResponse pageAndSortResponse(int status, String msg, PageQueryItems<T> query) {
    ...
    public static <T> PageAndSortResponse successPageResponse(String msg, PageQueryItems<T> items) {
