...
import club.yuit.common.support.properities.BootLogLevelProperties;
import club.yuit.common.support.properities.BootSmsCodeProperties;
...
public class BootSecurityProperties {
    ...
    private String tokenSigningKey = "OAUTHBOOT@IUY09&098#UIOKNJJ-YUIT.CLUB1";
